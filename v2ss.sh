...
echo '{"inbounds":[{"port":8080,"protocol":"shadowsocks","settings": {"method": "aes-128-gcm","password": "hongchenpasswd"}}],"outbounds": [{"protocol": "freedom","settings": {}}]}'>$HOME/cloudfoundry/config.json
